...
function writeOperation(store: JournalStore, index: number, operation: JournalOperation) {
...
function appendAudit(store: JournalStore, count: number, event: JournalAudit) {
