  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'apps/apps-script/src/services/recipe-*.ts',
        'apps/apps-script/src/services/template-*.ts',
        'apps/apps-script/src/services/book-backup.ts',
        'apps/apps-script/src/platform/backup*.ts',
        'apps/apps-script/src/platform/private-resources.ts',
        'apps/apps-script/src/platform/recipe-archive.ts',
        'apps/apps-script/src/entrypoints/backup-recovery.ts',
        'apps/apps-script/src/platform/recipe-store.ts',
        'apps/apps-script/src/platform/recipes.ts',
        'apps/apps-script/src/platform/templates.ts',
        ...
        'apps/web/src/features/recipe-notebook/model/drafts.ts',
        'apps/web/src/features/recipe-notebook/model/save-queue.ts',
        'apps/web/src/features/recipe-notebook/model/recovery-memory.ts',
