...
Личная кулинарная тетрадь. Реализована основа репозитория (этап 1), опубликован HTTPS staging и проверена связь с Google API в целевых браузерах (часть этапа 0). Авторизация и хранение рецептов ещё впереди.
