...
Личная кулинарная тетрадь. Основа репозитория и HTTPS staging опубликованы. Схема и перенос пользователей выполнены, доступ владельца и читателя через таблицы подтверждён. Добавлен [раздел владельца](docs/workspace-admin.md): участники, роли и проверка структуры таблиц. Фото приняты владельцем. Оставшиеся проверки платформы отмечены в [roadmap](docs/roadmap.md); приглашения и хранение рецептов ещё впереди.
