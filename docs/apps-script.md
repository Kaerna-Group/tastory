...
Текущий серверный выпуск — **версия 7**, опубликована 3 сентября в 12:53:30 UTC из `d9441f7`: [журнал операций и аудит](operation-journal.md). Код редактора и снимок совпадают, manifest и URL сохранены. [Проверки выпуска](evidence/2026-09-03-operation-journal-release.json). Подготовка двух новых листов выполняется авторизованным владельцем в настройках Tastory; прежние импорт и активация не повторяются. Схема 2 сохраняет доступ owner/viewer и поддержку старого auth/spike контракта.
