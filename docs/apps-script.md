...
Текущий серверный выпуск — **версия 8**, опубликована 3 сентября в 13:47:09 UTC из `e5d9b85`: [приглашения и управление правами](access-management.md). Код редактора и снимок проверены, manifest и URL сохранены. [Проверки выпуска](evidence/2026-09-03-access-management-release.json). Используется уже подготовленная схема 2; миграция, импорт и изменение Script Properties не требуются. Настоящее первое приглашение и смена роли проверяются владельцем отдельно.
