...
Новый шаг D-02d-01: [журнал операций и аудит](operation-journal.md), подготовка из настроек и повтор без дубликатов.
...
Этап 2: схема, [перенос пользователей](users-import-staging.md) и доступ по таблицам подтверждены. Добавлены [раздел владельца](workspace-admin.md) и [основа журнала](operation-journal.md); дальше — приглашения и изменение доступа с аудитом.
