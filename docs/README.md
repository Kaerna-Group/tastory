...
Этап 2: схема, [перенос пользователей](users-import-staging.md) и доступ по таблицам подтверждены. Добавлен [раздел владельца](workspace-admin.md); дальше — журнал операций, аудит и управление приглашениями.
